...
#list x and x_with_nan value(not-a-number value)
x = [8.0, 1, 2.5, 4, 28.0]
x_with_nan = [8.0, 1, 2.5, math.nan, 4, 28.0] ### x_with_nan contains a nan value
x
x_with_nan

# Note: in Data Science missing values are common, and you’ll often replace them with nan.
# Note: How do you get a nan value?
# Can use the following function interchangeably:
float('nan')
math.nan
np.nan
...
# sample median - the middle element of a sorted dataset, an be sorted in increasing or decreasing order
